...
const NAV_ITEMS: Record<RoleGroup, NavItem[]> = {
  staff: [
    ...
    { path: '/portal/travel-authorisation', label: 'Official Forms', icon: Plane, description: 'Leave & travel documents' },
  ],
  hr: [
  ...
  manager: [
    ...
    { path: '/portal/travel-authorisation', label: 'Official Forms', icon: Plane, description: 'Review leave & travel forms' },
  ...
  procurement: [
    ...
    { path: '/portal/travel-authorisation', label: 'Official Forms', icon: Plane, description: 'Process leave & travel forms' },
