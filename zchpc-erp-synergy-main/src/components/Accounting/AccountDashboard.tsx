...
//         Accounting and finance features are currently managed on our external Odoo system.
//       </p>
//       <Button
//         onClick={() => window.open("https://erp.zchpc.ac.zw", "_blank")}
//         className="px-8 py-4 text-lg bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-md transition-colors"
//       >
//         Navigate to Odoo System
//       </Button>
//     </div>
//   );
// }
